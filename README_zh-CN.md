...
本项目是 [Lumina](https://github.com/MilkFeng/lumina)（作者 [MilkFeng](https://github.com/MilkFeng)，[MIT License](./LICENSE)）的**个人修改版**。

在原版基础上新增了以下功能：

- **系列合并** - 选中多本书合并为一个系列，书架上仅占一个位置，封面带数量角标、可自行切换；点击进入该系列的子书架
- **手动排序** - 长按封面拖动即可调整书籍、系列以及系列内书籍的顺序（顺序持久化保存）
- **按最近阅读排序的分类标签** - 顶部分类按组内最近阅读时间排列，越靠左越新
