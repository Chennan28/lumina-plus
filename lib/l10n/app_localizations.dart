...
abstract class AppLocalizations {
  ...
  /// Manual (drag) sort mode option
  ///
  /// In en, this message translates to:
  /// **'Manual Sort'**
  String get manualSort;

  /// Hint shown in the sort sheet when manual sort is active
  ///
  /// In en, this message translates to:
  /// **'Long-press and drag a cover to reorder items.'**
  String get manualSortHint;

  /// Selection bar action that merges selected books into a series
  ///
  /// In en, this message translates to:
  /// **'Merge into Series'**
  String get mergeIntoSeries;

  /// Dialog title for creating a new series
  ///
  /// In en, this message translates to:
  /// **'New Series'**
  String get newSeries;

  /// Label for the series name input
  ///
  /// In en, this message translates to:
  /// **'Series name'**
  String get seriesName;

  /// Hint text for the series name input
  ///
  /// In en, this message translates to:
  /// **'e.g. Sword Art Online'**
  String get seriesNameHint;

  /// Error message for an empty series name
  ///
  /// In en, this message translates to:
  /// **'Series name cannot be empty'**
  String get seriesNameCannotBeEmpty;

  /// Toast shown after creating a series
  ///
  /// In en, this message translates to:
  /// **'Series "{name}" created'**
  String seriesCreated(String name);

  /// Toast shown after merging books into a series
  ///
  /// In en, this message translates to:
  /// **'Merged into "{name}"'**
  String mergedIntoSeries(String name);

  /// Error message when merging into a series fails
  ///
  /// In en, this message translates to:
  /// **'Failed to merge into series'**
  String get failedToMergeSeries;

  /// Action that dissolves a series (books stay on the shelf)
  ///
  /// In en, this message translates to:
  /// **'Dissolve Series'**
  String get dissolveSeries;

  /// Confirmation message before dissolving a series
  ///
  /// In en, this message translates to:
  /// **'Dissolve the selected series? The books will stay on the shelf.'**
  String get deleteSeriesConfirm;

  /// Toast shown after dissolving a series
  ///
  /// In en, this message translates to:
  /// **'Series "{name}" dissolved'**
  String seriesDeleted(String name);

  /// Error message when dissolving a series fails
  ///
  /// In en, this message translates to:
  /// **'Failed to dissolve series'**
  String get failedToDeleteSeries;

  /// Action that renames a series
  ///
  /// In en, this message translates to:
  /// **'Rename Series'**
  String get renameSeries;

  /// Action that switches the series cover to another member book's cover
  ///
  /// In en, this message translates to:
  /// **'Change Cover'**
  String get changeSeriesCover;

  /// Option that lets the app pick the series cover automatically
  ///
  /// In en, this message translates to:
  /// **'Auto'**
  String get autoCover;

  /// Toast shown after changing the series cover
  ///
  /// In en, this message translates to:
  /// **'Cover updated'**
  String get coverUpdated;

  /// Action that removes selected books from a series
  ///
  /// In en, this message translates to:
  /// **'Remove from Series'**
  String get removeFromSeries;

  /// Toast shown after removing books from a series
  ///
  /// In en, this message translates to:
  /// **'Removed from series'**
  String get removedFromSeries;

  /// Error message when removing books from a series fails
  ///
  /// In en, this message translates to:
  /// **'Failed to remove from series'**
  String get failedToRemoveFromSeries;

  /// Empty state message on the series shelf screen
  ///
  /// In en, this message translates to:
  /// **'This series has no books yet'**
  String get seriesIsEmpty;

  /// Action that enters selection mode
  ///
  /// In en, this message translates to:
  /// **'Select'**
  String get select;
